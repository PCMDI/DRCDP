...
inputJson = 'nClimGrid-STAR-ESDM_CMIP6_input.json'
...
if inputJson =='nClimGrid-STAR-ESDM_CMIP6_input.json': 
    inputFilePath = '/global/cfs/projectdirs/m2637/star-esdm_nclimgrid_conus/' + vr + '/ssp245/downscaled.ACCESS-CM2.r1i1p1f1.' + vr + '.ssp245.g*.nclimgrid.nclimgrid.*.tllc.nc'
#   inputFilePath = inputFilePath.reaplace('tasmax',vr)
...
#   if exp in ['ssp245', 'ssp585']: yrs = yrs_scen
    ...
    fc = xc.open_mfdataset(fi,decode_times=False,use_cftime=False)
